...
public class ReportesProgresoAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reportes_progreso_admin);

        recyclerViewReporte = findViewById(R.id.recyclerViewReporteEnProgreso);
