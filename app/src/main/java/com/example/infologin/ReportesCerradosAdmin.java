...
public class ReportesCerradosAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reportes_cerrados_admin);

        recyclerViewReporte = findViewById(R.id.recyclerViewReporteCerrados);
